...
public class Gene {
	...
	public Gene[] reproduce(Gene other) {
		...
		int crossoverPoint = getChromosomeSize() / 2;
		for(int i = 0; i < crossoverPoint; i++) {
			int temp = getChromosomeElement(i);
			setChromosomeElement(i, other.getChromosomeElement(i));
			other.setChromosomeElement(i, temp);
		}
